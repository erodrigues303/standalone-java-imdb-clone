...
// new ImageIcon(url).getImage().getScaledInstance(150, 225,
// Image.SCALE_SMOOTH));
...
// MovieUI movieUI = new MovieUI(movie, user);
...
// cardPanel.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10)); // Add
// spacing between movie entries
// cardPanel.setPreferredSize(new Dimension(200, 300)); // Set preferred size
// for each movie panel

// // Title with year and rating
// String titleText = String.format(
// "<html><b><u>%s</u></b> (%d) <font color='red'><br>%s/10
// &#9733;</font></html>",
